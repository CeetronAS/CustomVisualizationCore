...
/// 
//--------------------------------------------------------------------------------------------------
TEST(OverlayTextBoxTest, Sizeing)
{
    ref<Font> myFont = new FixedAtlasFont(FixedAtlasFont::STANDARD);
    OverlayTextBox tb(myFont.p());
    ...
    EXPECT_EQ(500, tb.minimumSize().x());
    EXPECT_EQ(100, tb.minimumSize().y());
    EXPECT_EQ(500, tb.maximumSize().x());
    EXPECT_EQ(100, tb.maximumSize().y());
}
