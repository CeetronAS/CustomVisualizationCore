...
bool Texturing::onInitialize()
{
    ...
    m_renderSequence->firstRendering()->addOverlayItem(new cvf::OverlayAxisCross(m_camera.p(), new cvf::FixedAtlasFont(cvf::FixedAtlasFont::STANDARD)), cvf::OverlayItem::BOTTOM_LEFT, cvf::OverlayItem::HORIZONTAL);
