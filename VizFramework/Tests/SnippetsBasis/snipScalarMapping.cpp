...
bool ScalarMapping::onInitialize()
{
    ...
    rendering->addOverlayItem(m_axisCross.p(), OverlayItem::BOTTOM_LEFT, OverlayItem::VERTICAL);
    rendering->addOverlayItem(m_legend.p(), OverlayItem::BOTTOM_LEFT, OverlayItem::VERTICAL);
