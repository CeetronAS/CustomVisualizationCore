...
bool RenderToTexture::onInitialize()
{
    ...
    // Setup second rendering
    {
        ...
        m_mainRendering->addOverlayItem(new OverlayAxisCross(m_camera.p(), new FixedAtlasFont(FixedAtlasFont::STANDARD)), OverlayItem::BOTTOM_LEFT, OverlayItem::HORIZONTAL);
