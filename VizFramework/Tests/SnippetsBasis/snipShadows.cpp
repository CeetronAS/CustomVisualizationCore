...
//         overrideEffect->setRenderState(po);
    ...
    // -------------------------------------------------------------------------
    {
        ...
        mainRendering->addOverlayItem(new OverlayAxisCross(m_camera.p(), new FixedAtlasFont(FixedAtlasFont::STANDARD)), OverlayItem::BOTTOM_LEFT, OverlayItem::HORIZONTAL);
