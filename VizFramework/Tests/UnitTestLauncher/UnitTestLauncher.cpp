...
/// 
//--------------------------------------------------------------------------------------------------
void ReplaceAllOccurences(std::string* str, const std::string& lookFor, const std::string& replaceWith)
{
...
int main(int argc, char **argv) 
{
    ...
    for (i = 0; i < numUnitTests; i++)
    {
        ...
        // For now, crude impl with conversion to lowercase and dropping to std::string to do replacement
        String fullUnitTestPath;
        {
            std::string testPath = myExecPath.toLower().toStdString();
            ReplaceAllOccurences(&testPath, "unittestlauncher", unitTestName.toStdString());
