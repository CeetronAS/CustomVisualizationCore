...
#include "SnippetFactoryModules.h"
...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    cvfu::SnippetFactory* factoryModules = new SnippetFactoryModules;
    factoryModules->setTestDataDir(testDataDir);
    cvfu::SnippetRegistry::instance()->addFactory(factoryModules);
